...
"YES","NO","MAYBE*","SO","WHY",
  ...
  "THIS","THAT","THEY","YOU","I",
    "AM","HAVE","THE","ON","ME",
  	"LOOK","MUST","WITH","THOSE","IT",
  	"NOT","LIFE","WAY","AND","OKAY","YOUR"
			
  };
const char *SWAPS[NUMSWAPS][45] = {
...
int ResponsesPerKeyword[NUMKEYWORDS][5]= {
8,8,8,8,4,
5,5,4,5,4,
4,6,5,3,2,
5,6,7,8,4,
